...
function setText() {
  ...
  text.innerText = '凌霞，我爱你';
  text.setAttribute('style', 'position:fixed;top:50%;left:50%;color:#fca5cd;font-size:20px;font-weight:bold;transform:translate(-50%, -50%);margin-top:-10px');
